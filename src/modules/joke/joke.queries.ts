...
export const QUERY_STRING_GET_JOKES_BY_AUTHOR = 'SELECT * FROM jokes WHERE author ~* $1';
export const QUERY_STRING_GET_JOKES_BY_NAME = 'SELECT * FROM jokes WHERE name ~* $1';
